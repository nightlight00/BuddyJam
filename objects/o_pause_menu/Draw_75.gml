...
draw_sprite_ext(sprite_index, image_index, 64, 32, width/sprite_width, height/sprite_height, 0, c_white, 0.25);
...
for (var i = 0; i < op_length; i++)
{
	...
	draw_text_color(64 + op_border, 32 + op_border + op_space * i , option[menu_level, i], _c, _c, _c, _c, 1);
}
